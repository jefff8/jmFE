	...
	mui.plusReady(function(){
		...
		var before_ph3=document.getElementById('before_ph3');
		before_ph3.addEventListener('tap',function () {
			myactionSheet('rwfj4');
		});	
...
//		outLine( "成功："+p );
		...
		plus.io.resolveLocalFileSystemURL( p, function ( entry ) {
			var pic=document.getElementById("my_img_id");
		  	var before_ph=document.getElementById("before_ph3");
...
function createItem( p,lx ) {
	if (lx=='rwfj4') {
		files_rwfj4.push({name:"upfile"+index_rwfj4,path:p});
		index_rwfj4++;
	}
}
////////////上传文件/////////////////////////////////////////////
